...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="dynamodb-sample" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" samples.dynamodb.DynamoDBExecutor %CMD_LINE_ARGS%
