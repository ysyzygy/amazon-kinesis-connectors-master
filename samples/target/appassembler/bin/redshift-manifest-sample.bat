...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="redshift-manifest-sample" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" samples.redshiftmanifest.RedshiftManifestExecutor %CMD_LINE_ARGS%
