...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="elastic-search-sample" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" samples.elasticsearch.ElasticsearchExecutor %CMD_LINE_ARGS%
